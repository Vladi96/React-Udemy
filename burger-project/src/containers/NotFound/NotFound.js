...
const notFound = () => (
  <Aux className="NotFound">
    <div className="Background-NotFound">
      <div className="Ground-NotFound" />
    </div>
    <div className="Container-NotFound">
      <div className="Left-section-NotFound">
        <div className="Inner-content-NotFound">
          <h1 className="Heading-NotFound">404</h1>
          <p className="Subheading-NotFound">
            Looks like the page you were looking for is no longer here.
          </p>
        </div>
      </div>
      <div className="Right-section-NotFound">
        <svg
          className="Svgimg-NotFound"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="51.5 -15.288 385 505.565"
        >
          <g className="Bench-legs-NotFound">
            <path
          ...
          <g className="Top-bench-NotFound">
            <path
          ...
          <g className="Bottom-bench-NotFound">
            <path
          ...
          <g id="lamp">
            <path
              className="Lamp-details-NotFound"
          ...
          c0-1.257,0.73-2.278,1.633-2.278h10.621c0.903,0,1.633,1.02,1.633,2.278V421.997z"
            />
            <path
              className="Lamp-accent-NotFound"
          ...
          S149.306,67.362,149.306,71.528z"
            />
            <radialGradient
              className="Light-gradient-NotFound"
              id="SVGID_1_"
              cx="119.676"
              cy="44.22"
              r="65"
            ...
            <circle
              className="Lamp-light__glow-NotFound"
              fill="url(#SVGID_1_)"
              cx="119.676"
              cy="44.22"
              r="65"
            />
            <path
              className="Lamp-bottom-NotFound"
